       ...
       <li class="list-item__content" v-for="(shop, index) in shops" :key="index">
         <div class="card-item">
          ...
          <button class="btn-heart">
            {{ shop.shop_id }}
            <img src="../assets/icon_heart_white.png" class="btn-heart__img" @click="fav(index)" alt="白ハート">
            <img src="../assets/icon_heart_pink.png" class="btn-heart__img" @click="favDel(index)" alt="赤ハート">
          </button>
         </div>
         <!-- [/card-item] -->
       </li>
